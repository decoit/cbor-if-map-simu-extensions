 ...
 */
@Slf4j
public class CBORServiceIpTest extends AbstractSimuTestBase {
	...
	public void testConstructor() {
		CBORServiceIp instance = new CBORServiceIp(publisherId, ifMapTimestamp);
	...
	public void testConstructor_ClientSide() {
		CBORServiceIp instance = new CBORServiceIp();
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84040588006F6D792D7075626C69736865722D696401C11A4ED9E8B202"
	...
	public void testEquals_False() {
		CBORServiceIp instance1 = new CBORServiceIp(publisherId, ifMapTimestamp);
		CBORServiceIp instance2 = new CBORServiceIp(publisherId2, ifMapTimestamp2);
	...
	public void testEquals_True() {
		CBORServiceIp instance1 = new CBORServiceIp(publisherId, ifMapTimestamp);
		CBORServiceIp instance2 = new CBORServiceIp(publisherId, ifMapTimestamp);
