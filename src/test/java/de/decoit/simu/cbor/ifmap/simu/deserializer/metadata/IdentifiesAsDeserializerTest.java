 ...
 */
@Slf4j
public class IdentifiesAsDeserializerTest extends AbstractSimuTestBase {
	...
	public void testDeserialize() throws Exception {
		byte[] input = DatatypeConverter.parseHexBinary("84040988006F6D792D7075626C69736865722D696401C11A4ED9E8B202"
		...
		String dictPath = "<" + SimuNamespaces.SIMU + ">" + CBORIdentifiesAs.XML_NAME;
		DictionarySimpleElement dse = DictionaryProvider.getInstance().findElementByPath(dictPath);
		
		CBORIdentifiesAs result = IdentifiesAsDeserializer
										.getInstance()
