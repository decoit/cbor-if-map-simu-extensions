 ...
 */
public class ServiceDiscoveredByDeserializerTest extends AbstractSimuTestBase {
	...
	public void testDeserialize() throws Exception {
		byte[] input = DatatypeConverter.parseHexBinary("84040C88006F6D792D7075626C69736865722D696401C11A4ED9E8B202"
		...
		String dictPath = "<" + SimuNamespaces.SIMU + ">" + CBORServiceDiscoveredBy.XML_NAME;
		DictionarySimpleElement dse = DictionaryProvider.getInstance().findElementByPath(dictPath);
		
		CBORServiceDiscoveredBy result = ServiceDiscoveredByDeserializer
											.getInstance()
