 ...
 */
@Slf4j
public class CBORServiceImplementationTest extends AbstractSimuTestBase {
	...
	public void testConstructor_ClientSide() {
		CBORServiceImplementation instance = new CBORServiceImplementation();
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84040688006F6D792D7075626C69736865722D696401C11A4ED9E8B202"
	...
	public void testEquals_False() {
		CBORServiceImplementation instance1 = new CBORServiceImplementation(publisherId, ifMapTimestamp);
		CBORServiceImplementation instance2 = new CBORServiceImplementation(publisherId2, ifMapTimestamp2);
	...
	public void testEquals_True() {
		CBORServiceImplementation instance1 = new CBORServiceImplementation(publisherId, ifMapTimestamp);
		CBORServiceImplementation instance2 = new CBORServiceImplementation(publisherId, ifMapTimestamp);
