...
/**
 * Java representation of the file-monitored metadata from the SIMU namespace.
 *
...
@Slf4j
public final class CBORFileMonitored extends AbstractSingleValueMetadata {
	public static final String XML_NAME = "file-monitored";


	/**
	 * Create a new file-monitored metadata.
	 ...
	 */
	public CBORFileMonitored(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
