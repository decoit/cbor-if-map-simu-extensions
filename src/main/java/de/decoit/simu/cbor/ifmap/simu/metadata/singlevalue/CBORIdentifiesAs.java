...
/**
 * Java representation of the identifies-as metadata from the SIMU namespace.
 *
...
@Slf4j
public final class CBORIdentifiesAs extends AbstractSingleValueMetadata {
	public static final String XML_NAME = "identifies-as";


	/**
	 * Create a new identifies-a metadata.
	 ...
	 */
	public CBORIdentifiesAs(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
